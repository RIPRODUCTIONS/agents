---
name: hire-team
description: Onboard the full 7-agent engineering team — Architect, UX, Full Stack, DevOps, QA, Security, and Local Review — and guide the user through the recommended workflow.
---
